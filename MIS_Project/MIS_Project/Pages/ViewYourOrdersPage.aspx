<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewYourOrdersPage.aspx.cs" Inherits="MIS_Project.ViewYourOrders" %>
...
<body style="background-image: url('../Img/l2.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-position: center center">
    <form id="form1" runat="server">
        <h1 class="HEADER">View Your Orders</h1>
        <table class="auto-style2">
            ...
            <tr>
                ...
                <td class="auto-style10">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Order_ID" DataSourceID="SqlDataSource1" CellPadding="2" ForeColor="Black" GridLines="None" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px">
